...
import tex_man as legacy
import tex_man_entry as compat
from makemap_compat import read_palette
from stock_palettes import STOCK_PALETTE_NAMES, get_stock_palette
